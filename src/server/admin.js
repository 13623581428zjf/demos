...
export const get_user = (data) => {
	console.log(data)
	return axios.get('proxy/admin/user',{
		params:data
	}).then(result => {
		console.log(result)
...
export const change_userVIP = (data) => {
	console.log(data)
	return axios.request({
		url: 'proxy/admin/setVIP',
		method: 'post',
...
export const delete_user = (data) => {
	console.log(data)
	return axios.delete('proxy/admin/user',{
		params:data
	}).then(result => {
		console.log(result)
		return getAjax(result);
...
//获取类型
export const get_type = (data) => {
	console.log(data)
	return axios.get('proxy/admin/type',{
		params:data
	}).then(result => {
		console.log(result)
		return getAjax(result);
...
export const delete_type = (data) => {
	console.log(data)
	return axios.delete('proxy/admin/type',{
		params:data
	}).then(result => {
		console.log(result)
		return getAjax(result);
...
export const get_content = (data) => {
	console.log(data)
	return axios.get('proxy/admin/content',{
		params:data
	}).then(result => {
		console.log(result)
		return getAjax(result);
...
export const delete_content = (data) => {
	console.log(data)
	return axios.delete('proxy/admin/content',{
		params:data
	}).then(result => {
		console.log(result)
		return getAjax(result);
