...
$(function() {
	function e(e) {
		if(v = e.offsetLeft > o.offsetLeft ? 1 : e.offsetLeft < o.offsetLeft ? 2 : 0) {
			...
			}), e.offsetLeft > o.offsetLeft ? (l.style.background = "#e15671", f.style.background = "url(img/nav_bg.gif) repeat-x", move(l, {
				width: 40,
				right: -20
			}, 150), move(f, {
				width: 40,
				left: -20
			}, 150)) : e.offsetLeft < o.offsetLeft && (l.style.background = "url(img/nav_bg.gif) repeat-x", f.style.background = "#e15671", move(l, {
				width: 40,
				right: -20
			}, 150), move(f, {
				width: 40,
	...
	function t() {
		move(l, {
			...
			l.style.background = "url(img/nav_bg.gif) repeat-x", move(l, {
				width: 20,
				right: -10
			}, 80, "linear", function() {
				move(l, {
